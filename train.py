...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset", default="./dataset2_aug.yaml", help="要用的dataset的配置文件（path）")
    parser.add_argument("--weight", default="./runs/detect/train12/weights/best.pt", help="要训练的初始权重（path）")
    parser.add_argument("--epochs", default=500, help="训练的轮数")
